 ...
 * @author vinic
 */
public class CadCoordenador extends javax.swing.JFrame {

    /**
     * Creates new form CadCoordenador
     */
    public CadCoordenador() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Cadastro de coordenadores:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadCoordenador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadCoordenador().setVisible(true);
            }
        });
    }
